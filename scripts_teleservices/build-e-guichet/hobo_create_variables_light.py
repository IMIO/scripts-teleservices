...
Variable(
    name="commune_slug",
    label="Nom de la commune sans accent, sans espace (mettre des tirets), en minuscule.",
    value="ma-commune",
).save()
Variable(name="commune_cp", label="Code postal/postaux de la commune", value="1111").save()
Variable(
    name="administration_adresse",
    label="Adresse complète de l'administration",
    value="1, Place de l'administration - 1111 Ma Commune",
).save()
